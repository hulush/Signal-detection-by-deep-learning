...
import os
import cv2
from sklearn.utils import shuffle # index data


path = './DATA/'
signals = os.listdir(path)[1:]
...
model.fit( train_features, train_labels, validation_data=( test_features, test_labels ), shuffle=True, batch_size=128, nb_epoch=5 )
